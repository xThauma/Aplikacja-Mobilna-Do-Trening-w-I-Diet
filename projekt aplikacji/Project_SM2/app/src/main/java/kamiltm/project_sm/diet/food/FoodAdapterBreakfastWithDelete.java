...
public class FoodAdapterBreakfastWithDelete extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FoodAdapterBreakfastWithDelete(List<Food> foodList) {
        ...
        try {
            if (holder instanceof MyViewHolder) {
                ...
                vh.likeFoodBTN.setOnClickListener(e -> {
                    ...
                    JsonArrayRequest jsonObjectRequest = new JsonArrayRequest(Request.Method.GET, Constants.URL_INSERT_BREAKFAST_FAVOURITE_DATA + "?id=" + food.getId() + "&favourite=" + fav, null, response -> {
                    }, error -> {
