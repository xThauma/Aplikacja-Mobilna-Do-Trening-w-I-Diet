...
public class FoodAdapterDinnerWithDelete extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FoodAdapterDinnerWithDelete(List<Food> foodList) {
        ...
        try {
            if (holder instanceof MyViewHolder) {
                ...
                vh.likeFoodBTN.setOnClickListener(e -> {
                    ...
                    JsonArrayRequest jsonObjectRequest = new JsonArrayRequest(Request.Method.GET, Constants.URL_INSERT_DINNER_FAVOURITE_DATA + "?id=" + food.getId() + "&favourite=" + fav, null, response -> {
                    }, error -> {
