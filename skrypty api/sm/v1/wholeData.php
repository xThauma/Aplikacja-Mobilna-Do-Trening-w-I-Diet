...
$date = $_GET['date']; 
$stmt = $db->prepare("select * from breakfasts where id_users = :id_users and date = :date");
$stmt->bindParam(':id_users', $id_users);
$stmt->bindParam(':date', $date);
$stmt->execute();

$stmt3 = $db->prepare("select * from dinners where id_users = :id_users and date = :date");
$stmt3->bindParam(':id_users', $id_users);
$stmt3->bindParam(':date', $date);
$stmt3->execute();


$stmt4 = $db->prepare("select * from suppers where id_users = :id_users and date = :date");
$stmt4->bindParam(':id_users', $id_users);
